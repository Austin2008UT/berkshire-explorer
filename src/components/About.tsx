    ...
    <div className="about">
      <div className="about-container">
        ...
        <div className="about-content">
          ...
          <p>
            The Berkshire Explorer is a non-profit project I created and maintain. The intention is for it to be useful tool to myself and others to better understand Berkshire Hathaway and the great Warren Buffett and Charlie Munger. It has no connection to Berkshire Hathaway. All trademarks and content belong to their rightful owners—especially Berkshire Hathaway.
          </p>
          <p>
