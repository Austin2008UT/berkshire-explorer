    ...
    <div className="about">
      <div className="about-container">
        ...
        <div className="about-content">
          ...
          <p>
            The Berkshire Explorer is a non-profit project I built and maintain. It has no connection to Berkshire Hathaway. All trademarks and content belong to their rightful owners—especially Berkshire Hathaway.
          </p>
          <p>
